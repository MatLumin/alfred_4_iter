...
from_singular_seg(
	...
	<div id="hour_minute_flex">
		...
		<h1 id="minute_display">30</h1>    
	</div>
	<h2 id="unix_clock">1716908408</h2>
	<h2 id="full_date">5/28/2024</h2>		
...
from_singular_seg(
	...
	<img class="wind_logo" src="static/wind_logo.png" style="animation-duration: 2.91829s; animation-delay: 1.91285s;">	
	<img class="wind_logo" src="static/wind_logo.png" style="animation-duration: 2.91829s; animation-delay: 2.18492s;">	
...
from_singular_seg(
	...
	<img src="/static/gov_icon.png" class="main_logo" id="authority_logo_holder">
